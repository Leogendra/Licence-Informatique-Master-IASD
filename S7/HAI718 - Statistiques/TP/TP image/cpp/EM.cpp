...
int main(int argc, char* argv[]) {
	...
	double * tabdProp = new double[lNbGaussienne]; // proportions (généralement égales au départ)
	double * tabdMu = new double[lNbGaussienne]; // moyennes (doivent être différentes au départ)
	double * tabdSigma = new double[lNbGaussienne]; // écarts types (n'importe quelle valeur)
